        ...
        <div class="container">
            <div class="row">
                <div class="col-8">
                    ...
                    @endif
                    <form method="POST" action="{{ route('update_model_action') }}">
                        @csrf
                        <input type="hidden" name="tire_id" value="{{ $model->id }}" />
                        <div class="mb-3 row">
                        ...
                        <button type="submit" class="btn btn-primary mb-3">Update Model</button>
                    </form>
